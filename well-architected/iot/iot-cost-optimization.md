...
- [Azure SQL Database and cost optimization](/azure/architecture/framework/services/data/azure-sql-database-well-architected-framework#azure-sql-database-and-cost-optimization)
