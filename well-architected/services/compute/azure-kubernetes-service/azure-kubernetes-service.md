...
|**Cluster and workload architectures:** Design your CI/CD pipeline to enforce cost-saving practices. | Enforce pipeline constraints early in your development cycle, whether in pre-commit checks, pull request checks, delivery workflows, or any step that makes sense in your workload which would let you find and fix misconfigurations quickly, and helps you understand what you need to pay attention to by creating guardrails.|
