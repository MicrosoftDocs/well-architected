...
|Ensure that the connection to the back-end is re-encrypted.|Front Door doesn't support SSL passthrough. Front Door must hold the certificate to terminate the encrypted inbound connection.| For more information, refer to [/azure/frontdoor/end-to-end-tls?pivots=front-door-standard-premium#end-to-end-tls-encryption] |
