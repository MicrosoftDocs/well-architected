...
> - Deploy inside hub virtual networks or Azure Virtual WAN hubs
...
|Configure the user-defined routes (UDR) to force traffic to Azure Firewall.| In a traditional Hub & Spokes architecture, configure UDRs to force traffic to Azure Firewall for `SpoketoSpoke`, `SpoketoInternet`, and `SpoketoHybrid` connectivity. In Azure Virtual WAN, instead, configure [Routing Intent and Policies](https://learn.microsoft.com/azure/virtual-wan/how-to-routing-policies) to redirect private and/or Internet traffic through Azure Firewall. |
