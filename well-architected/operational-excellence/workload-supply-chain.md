...
-   **All proposed workload changes are made through the supply chain processes and tools.**
...
-   **Follow a layered approach to reflect different lifecycles**.

Foundational layers should remain static throughout most of the overall workload lifecycle, whereas application layers are expected to change frequently. To account for this, you should have different pipelines to affect changes at each layer.
