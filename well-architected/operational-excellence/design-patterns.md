...
|[Quarantine](/azure/architecture/patterns/quarantine)|Supports safe deployment practices (SDP) by making sure that compromised artifacts aren't consumed by the workload, which could lead to security breaches during progressive exposure deployments.|
