...
> :::image type="icon" source="../_images/ai.svg"::: **AI opportunity:** Developing and validating standards-based IaC templates, such as Bicep and Terraform templates, is often time-consuming and error-prone. AI streamlines template creation and validation to speed up your modernization efforts. Review all AI-generated code to meet accuracy and compliance requirements.
>
> AI can reduce deployment risks by reviewing templates for misconfigurations and validating compliance with organizational policies. It can simulate, forecast, and summarize risks by using natural language instructions.
...
## Use a layered approach for IaC pipelines
...
## Treat IaC and application code the same
...
## Use centralized standards and resources
...
> :::image type="icon" source="../_images/ai.svg"::: **AI opportunity:** To strengthen your security posture and speed up response times, integrate AI into your security reviews and threat modeling processes. 
>
> Enhance your existing security process by using AI tools and features to highlight coding patterns that aren't safe and suggest secure alternatives. Generative AI can analyze IaC templates and architectural diagrams, and then generate threat models and mitigations to support continuous threat modeling. Regularly update architectural diagrams and IaC templates.
