...
> :::image type="icon" source="../_images/ai.svg"::: **AI opportunity**: Writing work descriptions and acceptance criteria can be templatized based on organizational policies. Initial drafts based on those templates can be generated by CoPilot and enforce standards. AI agents grounded in those templates can generate work items for code reviews or RCS to ensure consistency and high-quality.
