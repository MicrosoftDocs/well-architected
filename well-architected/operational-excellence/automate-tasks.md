...
- **Scaling**: Make use of platform-provided functionality and other tools, like orchestration tools, to automatically scale your infrastructure when load increases or decreases.
...
- **Configuration management**: Make use of orchestration and policy tooling to ensure that all of your resources run the same configuration and that compliance requirements are enforced across your workload.
