...
To address discovery tasks, take advantage of model catalogs that include models from various providers. The [model catalog in Microsoft Foundry portal](/azure/ai-studio/how-to/model-catalog-overview) allows you to evaluate from among curated collections and deploy models efficiently. 
...
- [Content filtering in Foundry portal](/azure/ai-studio/concepts/content-filtering)
