...
| --- | --- | --- | --- | --- |
| [Microsoft Entra ID](/entra/msal/dotnet/advanced/exceptions/retry-policy) | Native in the Microsoft Authentication Library (MSAL) | Embedded in MSAL | Client | *MsalServiceException* headers |
| [Azure Cosmos DB](/azure/reliability/reliability-cosmos-db#resilience-to-transient-faults) | Native in the SDK | Configurable | Global | SDK diagnostics or logs |
| [Azure Data Lake Storage](/azure/reliability/reliability-storage-blob#resilience-to-transient-faults) | Native in the client | Programmatic | Client and individual operations |EventSource/*ILogger* |
| [Azure Event Hubs](/azure/reliability/reliability-event-hubs#resilience-to-transient-faults) | Native in client |Programmatic | Client | EventSource/*ILogger* |
| [Azure IoT Hub](/azure/reliability/reliability-iot-hub#resilience-to-transient-faults) | Native in the device or service SDK | Programmatic | Client | SDK logs |
| [Azure AI Search](/azure/architecture/best-practices/retry-service-specific#azure-search) | Native in the client | Programmatic | Client | EventSource/*ILogger* |
| [Azure Service Bus](/azure/reliability/reliability-service-bus#resilience-to-transient-faults) | Native in the client | Programmatic |Client | EventSource/*ILogger* |
| [Azure Service Fabric](/azure/service-fabric/service-fabric-disaster-recovery) | Native in the client | Programmatic | Client | None |
