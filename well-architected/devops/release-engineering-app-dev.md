...
You can review our documentation on [Forks and Branches](azure/devops/repos/git/forks?view=azure-devops&tabs=visual-studio) to find out more about the differences and similiarties between them.
