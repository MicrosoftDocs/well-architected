...
- [Remove Virtual Machine (VM) direct internet connectivity](/azure/architecture/well-architected/security/design-governance#remove-virtual-machine-vm-direct-internet-connectivity)
