...
| **Maintain the level of confidentiality** as data flows through various components of the system.     | *Assume breach*.  <br><br> Enforcing confidentiality levels throughout the system you to provide a consistent level of hardening. Doing so can **prevent vulnerabilities** that might result from moving data to a lower security tier.                                                                       |
