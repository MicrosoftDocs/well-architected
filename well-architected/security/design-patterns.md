...
|[Quarantine](/azure/architecture/patterns/quarantine)|Serves as the first responsibility of security validation invoked by consumers of external artifacts. The validation on an artifact is conducted in a segmented environment before it's used by the development process.|
