...
The following table describes the main functions for this reference model. See [Team roles and responsibilities](design-identity-role-definitions.md) to learn more about permissions for the main functions.
