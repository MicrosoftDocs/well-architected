...
- Use [traffic analytics](/azure/network-watcher/traffic-analytics) to analyze and enrich virtual network flow logs to surface insights into the traffic flow. With built-in queries, you can obtain insights into blocked traffic, malicious flows, and active ports exposed to the internet across your Azure infrastructure. Use traffic analytics to support Zero Trust security by enabling segmentation, visibility into traffic flows, and detection of anomalous or unauthorized activity across your Azure environment.  
