...
- [Design virtual network subnet security](/azure/architecture/well-architected/security/design-network-segmentation#design-virtual-network-subnet-security)
