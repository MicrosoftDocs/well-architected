...
|&#9744;|[SE:02](./secure-development-lifecycle.md)<br>[SE:02](./threat-model.md)|**Align secure development lifecycle (SDL) throughout the software development lifecycle (SDLC)** to ensure confidentiality, integrity, and availability of software and adopt a security-first mindset.|
