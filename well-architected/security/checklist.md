...
|&#9744;|[SE:02](./secure-development-lifecycle.md)|**Align secure development lifecycle (SDL) throughout the software development lifecycle** to ensure confidentiality, integrity, and availability of software and adopt a security-first mindset.|
