...
For example, the [Windows N-tier application on Azure with SQL Server](/azure/architecture/reference-architectures/n-tier/n-tier-sql-server) reference architecture uses Azure DDoS Protection Standard because this option:
