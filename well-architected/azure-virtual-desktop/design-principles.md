...
- *Resiliency* is the ability to withstand disruptions (transient faults, infrastructure issues, demand spikes) and continue operating (possibly in a degraded mode) to avoid user-impacting downtime.
