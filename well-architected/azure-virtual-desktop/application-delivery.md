...
- Virtual Machine Scale Set Flexible Orchestration (VMSS Flex) provides deployment options across zones or within the same zone across different fault domains (FDs) and update domains (UDs) for better reliability.
