...
![Cosmos DB Access Method Capabilities](/azure/cosmos-db/media/how-to-restrict-user-data/operations.png "Cosmos DB Access Method Capabilities")
...
![The Cosmos DB Transactional Row Store and Analytical Column Store, with Auto-Sync from Transactional to Analytical](/azure/cosmos-db/media/analytical-store-introduction/transactional-analytical-data-stores.png "The Cosmos DB Transactional Row Store and Analytical Column Store, with Auto-Sync from Transactional to Analytical (Source: Microsoft Azure Documentation)")
...
![Azure Synapse Analytics Overview](/azure/synapse-analytics/media/overview-what-is/synapse-architecture.png "Azure Synapse Analytics Overview (Source: Microsoft Azure Documentation)")
