...
All functional aspects of a solution must be capable of scaling to meet changes in demand, ideally [auto-scaling](/azure/architecture/best-practices/auto-scaling) in response to load.
