...
|[**Data platform**](mission-critical-data-platform.md)|Choices in data store technologies, informed by capacity, throughput, data model, consistency, and governance requirements. |
...
|[**Health modeling and observability**](../design-guides/health-modeling.md)|Processes to define a robust health model, mapping quantified application health states through observability and operational constructs to achieve operational maturity.|
