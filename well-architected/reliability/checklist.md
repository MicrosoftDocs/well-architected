...
| &#9744; |[RE:07](background-jobs.md) <br> [RE:07](self-preservation.md) <br> [RE:07](handle-transient-faults.md)  |  **Strengthen the resiliency and recoverability of your workload by implementing self-preservation and self-healing measures**. Use well-established patterns and techniques to help your workload remain functional during and recover from incidents.   |
