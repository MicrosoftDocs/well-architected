...
| &#9744; |[RE:10](monitoring-alerting-strategy.md)     |  **Measure and publish the solution's health indicators**. Continuously capture uptime and other reliability data from across the workload and also from individual components and key flows. Configure alerting to notify appropriate parties and trigger automatic self-healing actions when malfunctions are detected.     |
