...
*Virtual Machine backup* - Back up and restore of Azure VM data through the Azure portal. Cross-region restoration lets you restore Azure VMs that were to a paired secondary region.
...
**(3) Use snapshots** - A snapshot backup is a point-in-time, copy of your data. The speed and reliability of snapshot backups can help manage large databases and protect the primary database against corruption or failure. They're critical for disaster recovery. We have a few options to create and store backups for your SAP workload.
