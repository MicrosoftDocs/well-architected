...
- [Grounding data design for AI workloads on Azure](./ai/grounding-data-design.md): We moved the security trimming explanation to its own paragraph for better readability.
