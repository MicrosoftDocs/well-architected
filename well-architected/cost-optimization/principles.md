...
| Make critical metrics visible to stakeholders     | Critical metrics such as utilization, spending, error rate etc should be tracked and placed in front of engineers and stakeholders. This enables continuous inspection, spotting excess spend and tuning operations to trim expenses.|
