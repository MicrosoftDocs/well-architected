...
| **Deploy to regions** that cost less. | Some regions offer services at a cheaper price. If you can still meet functional and nonfunctional requirements, you should consider using those regions. If you can't move the production environment, consider running preproduction environments (Dev, Test, QA) in different regions to optimize costs. |
