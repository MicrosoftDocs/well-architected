...
| **Use consumption-based pricing** when it's practical.     | You'll pay for exactly what you use. This option might be more expensive than a fully utilized pre-paid option. However, **if you don't expect to fully utilize pre-purchased compute**, consumption billing might be a better choice.     |
...
| **Deploy to regions** that cost less.| If you can still meet functional and non-functional requirements, you can save money by **selecting a region that has favorable pricing** for your resources.         |
