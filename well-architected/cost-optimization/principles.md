...
| Align cost and business model.      | Architecture should follow the money. For example you can architect your e-commerce application so that when the number of orders go up, infrastructure and operation costs rise.
