...
Keep the following high-level architecture model in mind when considering these points.
![Diagram showing the high level architecture model of carrier-grade workloads.](./images/carrier-grade-overview-arch.png "Carrier Grade High-level Architecture")
