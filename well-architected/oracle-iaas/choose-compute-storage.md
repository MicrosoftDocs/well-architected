...
To get right-sizing recommendations for the required Azure infrastructure, you need to generate either an Automatic Workload Repository (AWR) report or an Statspack report for each database that you plan to migrate to Azure.
