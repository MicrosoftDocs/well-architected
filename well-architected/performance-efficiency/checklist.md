...
||  Code|        Recommendation|
|-|-|-|
| :::image type="icon" source="media/checkbox1.png":::|PE:&nbsp;01| **Define performance targets.** Performance targets are numerical values that derive from your requirements. Performance targets should exist for all workload flows.|
