...
:::image type="icon" source="../_images/trade-off.svg":::If the underlying data changes frequently, you need to implement cache invalidation mechanisms to ensure the cached data remains up to date.
