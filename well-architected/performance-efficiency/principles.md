...
These design principles can help **build your strategy for managing capacity** of resources to sufficiently meet your business requirements for expected usage. This strategy should also consider resource quotas and limits and expected growth in the period. Allocating over multiple regions can help avoiding the risk of a temporary resource capacity constraint in a single Azure region. Also, reduce wastage during off-peak hours. After you've decided on a strategy, solidify your design by using the [Performance Efficiency checklist](checklist.md).
