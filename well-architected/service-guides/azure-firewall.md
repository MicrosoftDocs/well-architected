...
>
>   Follow the [Zero Trust configuration guide for Azure Firewall and Application Gateway] if your security needs require that you implement a Zero Trust approach for web applications, such as implementing inspection and encryption. Use this guidance to integrate Azure Firewall and Application Gateway for both traditional hub-and-spoke and Virtual WAN scenarios.
>
