...
*As you make design choices for Azure* *Disk Storage review the .Design review checklist for Operational Exce*[llence](/azure/well-architected/operational-excellence/checklist)
...
| **Recommendation** | **Benefit** |
|---|---|
| **Use Azure Monitor to analyze metrics and create alerts.** | Azure Monitor provides insight in how your disks and VMs perform. <br> |
