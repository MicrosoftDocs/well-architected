...
| If you're managing your own snapshots, [copy them across regions](/azure/virtual-machines/disks-copy-incremental-snapshot-across-regions?tabs=azure-cli) using the provided scripts. | Using the provided scripts simplifies transferring data from one region to another. This is a good option if you can't use Azure Site Recovery, since you can still create disaster recovery backups in other regions. |
