...
| Use [Azure Metrics](/azure/virtual-machines/disks-metrics) to monitor your environment and ensure that your disks aren't being throttled. | Throttling leads to suboptimal performance and issues like increased latency. Using Azure Metrics lets you identify disks that are being throttled. |
