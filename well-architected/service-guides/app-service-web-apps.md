...
>
>   Consider network protocol requirements when designing your scaling strategy, ensuring that both IPv4 and IPv6 traffic patterns are covered. App Service supports inbound IPv6 connectivity alongside IPv4. IPv6-only networks can overcome IPv4 address exhaustion issues. However, IPv6-only clients, require IPv4-to-IPv6 translation services and creating potential network translation overhead. For more information, see [Inbound and outbound IP addresses in Azure App Service](/azure/app-service/overview-inbound-outbound-ips). 
>
