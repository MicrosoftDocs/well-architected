...
| *(Service)* Isolate unrelated APIs with [workspaces](/azure/api-management/workspaces-overview) or extra API Management instances. | Localizes the blast radius of failures caused by misconfiguration or outages by separating APIs across different compute instances. |
