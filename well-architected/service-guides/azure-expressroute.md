...
| [Configure ExpressRoute Global Reach](/azure/expressroute/expressroute-howto-set-global-reach) on your ExpressRoute circuit Premium SKU. [ExpressRoute Global Reach](/azure/expressroute/expressroute-global-reach). | ExpressRoute Global Reach provides an additional layer of redundancy by linking your on-premises networks across different geographical locations directly through the Azure backbone network. This ensures that your network remains connected and operational even if one Azure region becomes unavailable. |
...
>
> - **Get the best rates from providers:** Compare the rates of different service providers to get the best rates for your ExpressRoute circuit. Choose the right service provider based on the cost, performance, and reliability of the service. For more information, see .
>
...
| Configure [scalable ExpressRoute gateways](/azure/expressroute/expressroute-about-virtual-network-gateways#expressroute-scalable-gateway-preview) to set minimum and maximum scale units for the gateway, which autoscales based on active bandwidth or flow count. | This benefits you by enabling right-sizing of resources, providing flexibility to scale, optimizing performance, and supporting proactive cost management. This approach ensures that you're using resources efficiently and cost-effectively.|
