...
>
> - **Protect integrity** Implement access controls to authenticate and authorize user access to the system by using the least-privilege principle and using individual identities instead of keys.
>
