...
Azure Event Grid is a scalable, managed publish-subscribe service that distrubtes messages. Event Grid provides flexible message consumption patterns. It uses the Message Queuing Telemetry Transport (MQTT) and HTTP protocols to enable event-driven serverless architectures, data pipelines, and application integration.
