...
| (Cluster) Enable [autoscaling](/azure/service-fabric/how-to-managed-cluster-autoscale) for your cluster to add or reduce nodes on demand for a secondary node type.| Autoscaling reduces management overhead and potential business impact because you can monitor and optimize the amount of nodes that service your workload.|
