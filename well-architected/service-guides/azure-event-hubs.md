...
| Select appropriate [service tier](/en-us/pricing/details/event-hubs/) (Basic, Standard, Premium, or Dedicated) based on [economic analysis](/pricing/details/event-hubs/).<br><br>Configure [auto-inflate](/azure/event-hubs/event-hubs-auto-inflate) with maximum throughput unit limits based on budget constraints to prevent unexpected scaling costs.| Appropriate tier selection for workload characteristics optimizes costs, while setting a maximum for auto-inflate prevents unexpected cost increases.|
