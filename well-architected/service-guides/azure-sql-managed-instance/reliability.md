...
|Configure zone redundancy when available in the region your are deploying to. For more information, see [High availability architecture](/azure/azure-sql/database/reservations-discount-overview#reservations-for-zone-redundant-resources).| With Availability Zones configured, your compute and storage replicas are distributed across different availability zones. If one zone fails, the system automatically fails over to another zone without any data loss. |
...
<!-- Updated: August 17, 2025 for Azure Update 496135 -->
