...
>
>   A typical architecture might include Traffic Manager and multiple endpoints. Each endpoint is protected by an application gateway that handles TLS termination and other security functions. For a reference architecture that demonstrates that pattern, see [Multiregion load balancing with Traffic Manager, Azure Firewall, and Application Gateway](/azure/architecture/high-availability/reference-architecture-traffic-manager-application-gateway).
>
