...
| **Stop VMs during off-hours.** You can use the **[Azure Automation Start/Stop](/azure/azure-functions/start-stop-vms/overview)** feature and configure it according to your business needs. | The Start/Stop feature is a low-cost automation option that can significantly affect your idle instance costs. |
