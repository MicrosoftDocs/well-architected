...
| Review [Query Performance Insight](/azure/azure-sql/database/query-performance-insight-use) to identify the top resource consuming and long-running queries in your workload. | Query Performance Insight helps you spend less time troubleshooting database performance by providing deeper insight into database queries by metrics such as CPU, duration, and execution count.|
